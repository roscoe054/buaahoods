...
buaaeatingFactorys.factory('Data', function() {
	...
	return {
		dishes: [
			DishType.createNew("108", "尖椒肥肠盖饭", "16", "肥肠+尖椒+鸡蛋饼", "/assets/images/jianjiaofeichang.jpg"),
			DishType.createNew("109", "蛋炒饭", "10", "香肠+鸡蛋+香菇", "/assets/images/danchaofan.jpg"),
...
buaaeatingFactorys.factory('Service', function($http, Data, $localStorage, $rootScope) {
	...
	service.submitOrder = function(callback) {
		...
		reqData = {
			...
			discountCode: orderInfo.discountCode || "", // TODO
			name: openid, // TODO
			nickname: userName,
